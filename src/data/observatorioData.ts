...
/**
 * Dataset V31, normalizado para o domínio React.
...
export const observatorioData: ObservatoryData = {
  meta: {
    ...
    edition: 'V31 • integridade do feed, rastreabilidade e atualização',
  ...
  indicators: [
    ...
    { id: 'idebInitial', label: 'IDEB anos iniciais', value: 5.5, unit: 'pontos', status: 'historical', referenceDate: '2023-12-31', sourceId: 'inep-2023' },
    { id: 'idebFinal', label: 'IDEB anos finais', value: 4.9, unit: 'pontos', status: 'historical', referenceDate: '2023-12-31', sourceId: 'inep-2023' },
