...
export const observatorioData: ObservatoryData = {
  ...
  indicators: [
    ...
    { id: 'density', label: 'Densidade demográfica 2026', value: 1303.21, unit: 'hab/km²', status: 'derived', referenceDate: '2026-07-01', sourceId: 'ibge-estimativas-2026', note: '249.978 ÷ 191,817 km².' },
    ...
    { id: 'electorateShare', label: 'Razão eleitorado/população', value: 50.03, unit: '%', status: 'derived', sourceId: 'tse-eleitorado-2026', note: 'Razão estatística entre universos distintos; não é comparecimento.' },
