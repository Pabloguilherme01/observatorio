...
const items: readonly SocialItem[] = [
  ...
  { id: 'eleitoral', label: 'Nomes acompanhados', value: (publicCandidates.length || electoral360Snapshot.matchedCandidates.length).toLocaleString('pt-BR'), note: 'recorte eleitoral acompanhado em Águas Lindas', anchor: 'eleitoral360' },
