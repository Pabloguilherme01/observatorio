...
const RECENT_KEY = 'observatorio-recent-sections-v32', FAVORITES_KEY = 'observatorio-favorite-sections-v32', REDUCED_KEY = 'observatorio-reduced-motion-v32', FAST_MODE_KEY = 'observatorio-fast-reading-v32';
