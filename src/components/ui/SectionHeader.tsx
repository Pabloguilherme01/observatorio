...
export function SectionHeader({ eyebrow, title, description, action, titleId }: { readonly eyebrow: string; readonly title: string; readonly description?: string; readonly action?: ReactNode; readonly titleId?: string }) {
  return (
    <div className="mb-6 flex flex-col gap-3 md:mb-7 md:flex-row md:items-end md:justify-between md:gap-5">
      <div className="min-w-0">
        <div className="mb-2 text-[10px] font-semibold uppercase tracking-[0.18em] text-sky-300/80 sm:text-[11px] sm:tracking-[0.2em]">{eyebrow}</div>
