...
const thematicIds = new Set([
  'contexto', 'demografia', 'transporte', 'politica', 'candidaturas',
  'eleitoral360', 'linha-do-tempo', 'orcamento', 'orcamento-impacto',
  'qualidade', 'evidencias', 'acao', 'instagram', 'saude', 'quiz', 'principios',
]);
...
export function MobileBottomNav() {
  ...
  useEffect(() => {
    ...
    const targetIds = new Set(['dashboard', 'resumo', 'descubra', 'eleitoral360', 'candidaturas', 'politica', 'eleitorado', 'dados', 'fontes', ...thematicIds]);
  ...
  return (
    <nav className="mobile-bottom-nav" aria-label="Navegação principal no celular" data-mobile-nav="primary">
