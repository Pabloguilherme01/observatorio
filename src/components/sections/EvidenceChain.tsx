      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <Card>
          ...
          <div className="mt-4 space-y-2 text-xs leading-5 text-slate-400 light:text-slate-600">
            ...
            <div><strong className="text-slate-200 light:text-slate-800">Commit:</strong> {generated.meta.gitCommit ?? 'não capturado'}</div>
        ...
        <Card>
          ...
          <div className="mt-4 space-y-2 text-xs leading-5 text-slate-400 light:text-slate-600">
            ...
            <div><strong className="text-slate-200 light:text-slate-800">Estado atual:</strong> a apuração oficial ainda não está aberta ao visitante; nenhum resultado é inferido.</div>
          </div>
