...
export function Central2026() {
  return <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6" aria-labelledby="central-title"><SectionHeader eyebrow="Central 2026" title="Acesso direto às fontes da eleição" description="O observatório funciona como camada de leitura; quando a informação precisa ser confirmada, o caminho oficial fica a um clique." />
