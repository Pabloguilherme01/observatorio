      ...
      <div className="quiz-shell">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-400">Cinquenta perguntas curtas. Cada resposta explica uma regra de leitura e aponta para a área correspondente do observatório.</p>
          </div>
