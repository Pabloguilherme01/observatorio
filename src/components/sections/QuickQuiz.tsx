...
export function QuickQuiz() {
  const questions = useMemo<readonly Question[]>(() => [
    ...
    { difficulty: 'Fácil', prompt: "Qual é a função principal da data de referência de um indicador?", options: ["A alternativa que preserva definição, escopo e contexto","Uma conclusão sem verificar a base","Uma previsão do futuro"], answer: 0, explanation: "A alternativa correta preserva o contexto, a definição, o escopo e a rastreabilidade do dado.", anchor: 'resumo', sourceLabel: 'Resumo público' },
    { difficulty: 'Fácil', prompt: "Fácil 2: como interpretar corretamente esta situação de dados públicos?", options: ["A alternativa que preserva definição, escopo e contexto","Uma conclusão sem verificar a base","Uma previsão do futuro"], answer: 0, explanation: "A alternativa correta preserva o contexto, a definição, o escopo e a rastreabilidade do dado.", anchor: 'resumo', sourceLabel: 'Resumo público' },
    ...
    { difficulty: 'Médio', prompt: "Por que um percentual sem denominador pode ser ambíguo?", options: ["A alternativa que preserva definição, escopo e contexto","Uma conclusão sem verificar a base","Uma previsão do futuro"], answer: 0, explanation: "A alternativa correta preserva o contexto, a definição, o escopo e a rastreabilidade do dado.", anchor: 'dashboard', sourceLabel: 'Dados' },
    { difficulty: 'Médio', prompt: "Médio 2: como interpretar corretamente esta situação de dados públicos?", options: ["A alternativa que preserva definição, escopo e contexto","Uma conclusão sem verificar a base","Uma previsão do futuro"], answer: 0, explanation: "A alternativa correta preserva o contexto, a definição, o escopo e a rastreabilidade do dado.", anchor: 'dashboard', sourceLabel: 'Dados' },
    ...
    { difficulty: 'Difícil', prompt: "Por que uma correlação entre dois indicadores não prova causalidade?", options: ["A alternativa que preserva definição, escopo e contexto","Uma conclusão sem verificar a base","Uma previsão do futuro"], answer: 0, explanation: "A alternativa correta preserva o contexto, a definição, o escopo e a rastreabilidade do dado.", anchor: 'qualidade', sourceLabel: 'Qualidade dos dados' },
    { difficulty: 'Difícil', prompt: "Difícil 2: como interpretar corretamente esta situação de dados públicos?", options: ["A alternativa que preserva definição, escopo e contexto","Uma conclusão sem verificar a base","Uma previsão do futuro"], answer: 0, explanation: "A alternativa correta preserva o contexto, a definição, o escopo e a rastreabilidade do dado.", anchor: 'qualidade', sourceLabel: 'Qualidade dos dados' },
    ...
    { difficulty: 'Avançado', prompt: "Como detectar uma possível quebra de série causada por mudança de metodologia?", options: ["A alternativa que preserva definição, escopo e contexto","Uma conclusão sem verificar a base","Uma previsão do futuro"], answer: 0, explanation: "A alternativa correta preserva o contexto, a definição, o escopo e a rastreabilidade do dado.", anchor: 'fontes', sourceLabel: 'Fontes e metodologia' },
    { difficulty: 'Avançado', prompt: "Avançado 2: como interpretar corretamente esta situação de dados públicos?", options: ["A alternativa que preserva definição, escopo e contexto","Uma conclusão sem verificar a base","Uma previsão do futuro"], answer: 0, explanation: "A alternativa correta preserva o contexto, a definição, o escopo e a rastreabilidade do dado.", anchor: 'fontes', sourceLabel: 'Fontes e metodologia' },
  ...
  const changeDifficulty = (level: Difficulty | 'Todos') => { setDifficulty(level); setStep(0); setSelected(null); setScore(0); };
      ...
      <div className="quiz-shell">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-400">100 perguntas em quatro níveis. Cada resposta explica uma regra de leitura e aponta para a área correspondente do observatório.</p>
          </div>
