...
export const QUESTION_BANK: readonly QuizQuestion[] = [
    ...
    { id: "q018", difficulty:'Fácil', prompt: "Quem lidera a pesquisa espontânea registrada em 2026?", options: ["Anderson Teodoro", "Keké", "Zé da Imperial", "Baiano dos Cocos"], answerIndex: 1, explanation: "Keké lidera com 35,25% na pergunta espontânea.", sourceId: "tse-pesquisas-2026" },
    { id: "q019", difficulty:'Fácil', prompt: "Qual instituto realizou a pesquisa GO-04133/2026?", options: ["Datafolha", "Ipec", "EXATA.GO Pesquisa", "Paraná Pesquisas"], answerIndex: 2, explanation: "A pesquisa é da EXATA.GO Pesquisa Ltda.", sourceId: "tse-pesquisas-2026" },
    { id: "q020", difficulty:'Fácil', prompt: "Qual o número de registro da pesquisa divulgada?", options: ["GO-04555/2026", "DF-04133/2026", "GO-04133/2025", "GO-04133/2026"], answerIndex: 3, explanation: "Registro GO-04133/2026 no TSE.", sourceId: "tse-pesquisas-2026" },
    { id: "q021", difficulty:'Fácil', prompt: "Quantas entrevistas teve a pesquisa?", options: ["400", "300", "500", "1.000"], answerIndex: 0, explanation: "Foram 400 entrevistas.", sourceId: "tse-pesquisas-2026" },
    ...
    { id: "q054", difficulty:'Médio', prompt: "Qual a população indígena do município?", options: ["891", "941", "33", "24.265"], answerIndex: 1, explanation: "941 pessoas indígenas conforme o recorte do TSE.", sourceId: "tse-eleitorado-2026" },
