  ...
  return <section id="eleitoral360" className="mx-auto max-w-7xl px-4 py-14 sm:px-6" aria-labelledby="electoral360-title">
    ...
    <div className="mt-4 grid gap-4 lg:grid-cols-[1.2fr_.8fr]">
      ...
      <div className="space-y-4">
        ...
        <Card><div className="text-xs font-bold uppercase tracking-wide text-slate-500">Recorte operacional</div><p className="mt-2 text-xs leading-5 text-slate-500">A watchlist é um recorte para cruzamento com o universo de Goiás; não representa o universo completo e não deve ser lida como lista exaustiva.</p><div className="mt-4 flex flex-wrap gap-2">{electoral360Snapshot.localWatchlist.map(name=><span key={name} className="rounded-full border border-white/8 px-2.5 py-1 text-[11px] text-slate-400">{name}</span>)}</div></Card>
      </div>
    </div>
