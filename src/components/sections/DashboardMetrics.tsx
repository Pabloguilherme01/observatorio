...
export function DashboardMetrics() {
  ...
  const metricDetails: readonly MetricDetail[] = [
    ...
    { label: 'Nome social', value: formatNumber(inclusionCount), caption: 'eleitores no snapshot eleitoral', icon: Gauge, sourceId: d.electoral.sourceId, referenceDate: d.electoral.snapshotDate },
