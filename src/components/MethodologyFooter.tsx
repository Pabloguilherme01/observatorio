...
export function MethodologyFooter({ source, referenceDate, denominator, formula, limitations }: Props) {
  return (
    <aside aria-label="Detalhes de metodologia e fonte" className="mt-4 rounded-2xl border border-white/8 bg-white/[0.02] p-4 text-xs leading-5 text-slate-500 light:border-slate-200 light:bg-slate-50">
      ...
      <a aria-label="Abrir fonte original em nova aba" className="mt-2 inline-flex items-center gap-1 font-semibold text-sky-300 hover:text-sky-200" href={source.url} target="_blank" rel="noopener noreferrer">
