export const navigation = [
  ...
  { id: 'principios', label: 'Princípios', shortLabel: 'Princípios', description: 'Método e correções', shortcut: 'G N' },
  ...
  { id: 'eleitoral360', label: 'Eleições 2026', shortLabel: 'Eleições', description: 'Snapshots, candidaturas e registros', shortcut: 'G X' },
  { id: 'linha-do-tempo', label: 'Linha do tempo', shortLabel: 'Timeline', description: 'Calendário eleitoral', shortcut: 'G L' },
  { id: 'quiz', label: 'Quiz', shortLabel: 'Quiz', description: 'Quiz de educação cívica', shortcut: 'G QZ' },
