...
must(electoral360Ui.includes('Nomes acompanhados no recorte') && electoral360Ui.includes('recorte editorial acompanhado') && electoral360Ui.includes('não representa o universo completo') && electoral360.includes("Este snapshot não representa o universo completo"), 'Eleitoral 360 deixa explícito o caráter editorial e não exaustivo do recorte');
