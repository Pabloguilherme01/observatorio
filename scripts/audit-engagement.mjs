...
must(read('public/404.html').includes('data-obs-spa-fallback') && read('public/404.html').includes('encodeURIComponent') && read('index.html').includes('obsSpaRestored'), 'fallback SPA preserva rota virtual entre 404.html e index.html');
