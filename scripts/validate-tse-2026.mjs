...
if (state !== 'not_synced' && state !== 'local_filter_pending' && state !== 'synced') {
  const allowedRetrievalMethods = new Set(['official_tse_open_data_csv', 'official_tse_zip_csv', 'official_tse_divulgacandcontas_api', 'official_tse_divulgacandcontas_api_via_reader_proxy', 'official_tse_mirror_secondary']);
